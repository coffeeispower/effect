 ...
 * @category Symbols
 */
export const StreamSchemaId: unique symbol = Symbol.for("@effect/cluster/ClusterSchema/Stream")

/**
 * @since 1.0.0
 * @category Schemas
 */
export const isStreamSchema = (schema: Schema.Schema.Any): schema is Stream<any, any> =>
